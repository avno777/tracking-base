const emailTemplate = {
  getOtpHtml: (otp: number, fullName: string) => {
    ...
    * {
    ...
    table, td { color: #000000; } #u_body a { color: #0000ee; text-decoration: underline; } @media (max-width: 480px) { #u_content_text_3 .v-container-padding-padding { padding: 10px 20px !important; } #u_content_text_3 .v-line-height { line-height: 150% !important; } #u_content_text_7 .v-container-padding-padding { padding: 10px 20px 20px !important; } #u_content_text_7 .v-line-height { line-height: 170% !important; } #u_content_text_4 .v-container-padding-padding { padding: 18px 0px 20px !important; } #u_content_text_4 .v-text-align { text-align: justify !important; } }
        </style>
    ...
    <table id="u_content_text_3" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      <tbody>
        <tr>
          <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:10px 20px 20px 50px;font-family:'Montserrat',sans-serif;" align="left">
            
      <div class="v-text-align v-line-height" style="font-size: 14px; color: #1b262c; line-height: 200%; text-align: center; word-wrap: break-word;">
        <p style="line-height: 150%; text-align: left;"><strong>Xin chào: ${fullName}</strong></p>
      </div>
    ...
    <table id="u_content_text_7" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div class="v-text-align v-line-height" style="font-size: 14px; color: #1b262c; line-height: 200%; text-align: center; word-wrap: break-word;">
        <p style="line-height: 170%; text-align: justify;">Đây là mã xác thực (OTP). Vui lòng nhập mã này để xác thực email của bạn với chúng tôi.</p>
      </div>
    ...
    <div class="v-text-align" align="center">
      <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:48px; v-text-anchor:middle; width:136px;" arcsize="125%"  stroke="f" fillcolor="#0088ee"><w:anchorlock/><center style="color:#FFFFFF;"><![endif]-->
        <a href="" target="_blank" class="v-button" style="box-sizing: border-box;display: inline-block;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #0088ee; border-radius: 60px;-webkit-border-radius: 60px; -moz-border-radius: 60px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;border-top-color: #CCC; border-top-style: solid; border-top-width: 0px; border-left-color: #CCC; border-left-style: solid; border-left-width: 0px; border-right-color: #CCC; border-right-style: solid; border-right-width: 0px; border-bottom-color: #0275a4; border-bottom-style: solid; border-bottom-width: 5px;font-size: 14px;">
          <span class="v-line-height" style="display:block;padding:15px 40px 14px;line-height:120%;"><strong><span style="font-size: 20px; line-height: 19.2px; letter-spacing: 7.5px">${otp}</span></strong></span>
        </a>
    ...
    <table style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      ...
      <div class="v-text-align v-line-height" style="font-size: 14px; color: #1b262c; line-height: 200%; text-align: center; word-wrap: break-word;">
        <p style="line-height: 200%; text-align: center;"><strong>OTP sẽ hết hạn sau 5 phút</strong></p>
      </div>
    ...
    <table id="u_content_text_4" style="font-family:'Montserrat',sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
      <tbody>
        <tr>
          <td class="v-container-padding-padding" style="overflow-wrap:break-word;word-break:break-word;padding:18px 50px 20px;font-family:'Montserrat',sans-serif;" align="left">
            
      <div class="v-text-align v-line-height" style="font-size: 14px; color: #5f5f5f; line-height: 140%; text-align: center; word-wrap: break-word;">
        <p style="font-size: 14px; line-height: 140%; text-align: center;"><span style="font-size: 12px; line-height: 16.8px;">Vì lý do bảo mật, không chia sẻ mã này cho người khác.</span></p>
      </div>
